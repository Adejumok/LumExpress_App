...
public class SecureUser implements UserDetails {
    ...
    public Collection<? extends GrantedAuthority> getAuthorities() {
        ...
        user.getAuthorities().forEach(authority -> {
            addUserAuthorityToAuthoritiesList(authorities, authority);
        });
        return authorities;
    }

    private void addUserAuthorityToAuthoritiesList(List<SimpleGrantedAuthority> authorities, Authority authority) {
